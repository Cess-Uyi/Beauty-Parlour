...
router.delete("/pending/cancel/:appId", checkAuth, UsersController.users_cancel_appointment);

router.get("/transaction-history", checkAuth, UsersController.users_transaction_history)
...
router.put("/changepassword/:userId", checkAuth, UsersController.users_changePassword);
