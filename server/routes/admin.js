...
router.post('/services/', [
    body('name')
    .isAlpha()
    .withMessage('Service name must be alphabetic'),
  ],
checkAuth,
AdminController.services_create_service);


router.put('/services/:serviceId', checkAuth, AdminController.services_edit_service)

  
router.delete('/services/:serviceName', checkAuth, AdminController.services_delete_service)
